...
def get_cached_settings():
    """جلب الإعدادات مع تخزين مؤقت وإعادة محاولة تلقائية"""
    now = time.time()
...
def pre_process():
    ...
    try:
        ...
        <div style='direction:rtl; background:#0a0a0a; color:#e74c3c; padding:30px; text-align:center;'>
            ...
            <p>لم نتمكن من الاتصال بقاعدة البيانات. يرجى تحديث الصفحة بعد بضع ثوانٍ.</p>

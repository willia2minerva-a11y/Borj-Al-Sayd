...
app.config['SECRET_KEY'] = 'sephar-maze-emperor-ultimate-v8-facebook-style'
...
def register():
    if request.method == 'POST':
        ...
        # 💡 نظام التفعيل اليدوي: أي مسجل جديد (غير الإمبراطور) يكون inactive
...
def declarations():
    ...
    # 💡 استدعاء صور الحسابات لستايل فيسبوك
